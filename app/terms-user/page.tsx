...
async function getTermsConditions() {
  const res = await fetch("https://api.presto-go.com/api/view-terms-conditions?owner_type=user", {
    cache: "no-store",
  });
  if (!res.ok) {
...
export default async function TermsConditionsUser() {
    ...
    <div className="min-h-screen bg-background-white py-16">
      <div className="section-shell">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl font-black text-secondary mb-4">Terms & Conditions (User)</h1>
